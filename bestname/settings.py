"""
Django settings for bestname project.
...
INSTALLED_APPS = [
    'newname.templatetags.custum_filters_tags',
    'newname.apps.NewnameConfig',
...
WSGI_APPLICATION = 'bestname.wsgi.application'
